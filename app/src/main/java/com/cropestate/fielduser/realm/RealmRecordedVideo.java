...
public class RealmRecordedVideo extends RealmObject {
    ...
    public RealmRecordedVideo(String videoid, String instructorcourseid, String title, String description, String url, String giflink, String thumbnail, int isactive, String created_at, String updated_at) {
