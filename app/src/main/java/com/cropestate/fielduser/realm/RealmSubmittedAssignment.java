...
public class RealmSubmittedAssignment extends RealmObject {
    ...
    public RealmSubmittedAssignment(String submittedassignmentid, String title, String url, int percentagescore, String assignmentid, String studentid, String created_at, String updated_at) {
