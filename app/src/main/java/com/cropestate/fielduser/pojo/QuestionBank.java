...
public class QuestionBank extends RealmObject {
    ...
    public QuestionBank(String quizid, String courseid, String title, String numberofquestions, String datecreated,
    ...
    public QuestionBank(String quizid, String courseid, String title, String numberofquestions, String datecreated, String dateoftest) {
        this.quizid = quizid;
        this.courseid = courseid;
        this.title = title;
        this.numberofquestions = numberofquestions;
