package com.cropestate.fielduser.pojo;
...
public class Participant extends RealmObject {
  ...
  private   String login_time;
   ...
   private String participant_type;
    ...
    public Participant(String std_name, String std_id, String std_image, String phone_number) {
    ...
    public Participant(String std_name, String std_id, String std_image, String phone_number, String login_time, String ismute, String participant_type, String duration) {
   ...
   private String duration;
    ...
    public Participant(String std_name, String std_id, String std_image, String phone_number, String login_time) {
        this.std_name = std_name;
        this.std_id = std_id;
        this.std_image = std_image;
        this.phone_number = phone_number;
